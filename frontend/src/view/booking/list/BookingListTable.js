                  ...
                  <tr key={row.id}>
                    <th className="th-checkbox" scope="row">
                      <div className="custom-control custom-checkbox">
                        ...
                        <td>
                          <PetListItem value={row[fields.pet.name]} />
                        </td>
                        <td>
                          {fields.arrival.forView(
                            row[fields.arrival.name],
                          )}
                        </td>
                        <td>
                          {fields.departure.forView(
                            row[fields.departure.name],
                          )}
                        </td>
                        <td>
